...
export const TrustedBy: React.FC = () => {
  const logos = [
    {
      name: "Vercel",
      svg: (
        <svg className="h-6 w-auto text-slate-400 hover:text-slate-900 transition-colors" viewBox="0 0 116 100" fill="currentColor">
    ...
    },
    {
      name: "Stripe",
      svg: (
        <svg className="h-6 w-auto text-slate-400 hover:text-slate-900 transition-colors" viewBox="0 0 80 33" fill="currentColor">
    ...
    },
    {
      name: "Linear",
      svg: (
        <svg className="h-6 w-auto text-slate-400 hover:text-slate-900 transition-colors" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    },
    {
      name: "Framer",
      svg: (
        <svg className="h-6 w-auto text-slate-400 hover:text-slate-900 transition-colors" viewBox="0 0 24 24" fill="currentColor">
  ...
  return (
    <section className="py-12 bg-white border-y border-slate-100/60 overflow-hidden">
